drop table if exists PhoneExtensions;
drop table if exists CSStaffTitles;
drop table if exists CSStaff;
drop table if exists Titles;

drop table if exists PathEdges;
...
create table Edges (
	edgeID varchar(15),
	startingLocationID varchar(10),
	endingLocationID varchar(10),
...
create table PathEdges (
	pathID varchar(15),
	edgeID varchar(20),
	sequencenumeric numeric(3),
	Constraint PathEdges_PK Primary Key (pathID, edgeID, sequencenumeric),
...
create table CSStaffTitles (
	accountName varchar(15),
	acronym varchar(20) Default 'Prof',
...
-- Populate PathEdges
INSERT INTO PathEdges (PATHID, EDGEID, SEQUENCEnumeric) 
